...
LAYOUT_ISO(
    ...
    K_PLAY_PAUSE, K_FAN_TOGGLE, K_2, K_3, IF_CONFIG(HAVE_MIC_MUTE, K_MIC_MUTE, K_4), K_5, K_6, K_NUM_7, K_NUM_8, K_NUM_9, K_NUM_ASTERISK, K_MINUS, K_EQUALS, K_BKSP,
    K_TAB, K_Q, K_W, K_E, K_R, K_T, K_Y, K_NUM_4, K_NUM_5, K_NUM_6, K_NUM_SLASH, K_BRACE_OPEN, K_BRACE_CLOSE, K_ENTER,
    K_FNLOCK, K_A, IF_CONFIG(HAVE_KB_PRIVACY, K_KB_PRIVACY, K_S), K_D, K_F, K_G, K_H, K_NUM_1, K_NUM_2, K_NUM_3, K_NUM_MINUS, K_QUOTE, K_BACKSLASH,
